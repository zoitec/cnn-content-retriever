...
class ContentRetriever {
    ...
    constructor(url) {
        ...
        this.timout = 5; // 5 seconds / 5000 millisconds
    }
    ...
    getBaseContentModel() {
        ...
        console.log(`Hypatia query: ${apiEndpoint}${query} with ${self.timeout} millisecond timeout`);

        return new Promise(function (resolve, reject) {
            try {
                console.log(`Request with ${self.timeout} timeout`);
